...
const defaultProps = {
  ...
  ariaLabel: "Date - type in format dd/mm/yy or use date picker below",
  startDateAriaLabel:
    "Start Date - type in format dd/mm/yy or use date picker below",
  endDateAriaLabel:
    "End Date - type in format dd/mm/yy or use date picker below",
...
class DatePicker extends React.Component {
  render() {
    ...
    const { ariaLabel, startDateAriaLabel, endDateAriaLabel } = this.props;

    return (
      <DatePickerContainer width={width} height={height} zIndex={zIndex}>
        {single ? (
          <SingleDatePicker ariaLabel={ariaLabel} {...pickerProps} />
        ) : range ? (
          <DateRangePicker
...
DatePicker.propTypes = {
  ...
  /** Specifies the aria-label for the Single DatePicker. */
  ariaLabel: PropTypes.string,
  /** Specifies the aria-label for StartDate input for the Range DatePicker. */
  startDateAriaLabel: PropTypes.string,
  /** Specifies the aria-label for EndDate input for the Range DatePicker. */
